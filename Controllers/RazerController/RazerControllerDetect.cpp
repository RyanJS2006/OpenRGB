...
REGISTER_HID_DETECTOR_IPU("Razer Blackwidow V4", /* firmware < 1.5 */        DetectRazerControllers,        RAZER_VID,  RAZER_BLACKWIDOW_V4_PID,                        0x03,   0x01,   0x00);
REGISTER_HID_DETECTOR_IPU("Razer Blackwidow V4", /* firmware >= 1.5 */   	 DetectRazerControllers,        RAZER_VID,  RAZER_BLACKWIDOW_V4_PID,                    	0x03,   0x0C,   0x01);
...
REGISTER_HID_DETECTOR_IPU("Razer Laptop Cooling Pad",                        DetectRazerControllers,        RAZER_VID,  RAZER_LAPTOP_COOLING_PAD_PID,                    0x00,   0x0C,   0x01);
